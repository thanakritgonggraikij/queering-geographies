...
with open("fugue_2005_for-spacy.json", "r", encoding="utf-8") as f: #! CHANGE DIRECTORY!!!!
    blocks = json.load(f)
...
with open("fugue_2005_spacy-processed.json", "w", encoding="utf-8") as f: #! CHANGE DIRECTORY!!!!
